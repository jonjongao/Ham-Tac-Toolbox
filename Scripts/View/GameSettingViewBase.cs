...
namespace HamTac
{
    public class GameSettingViewBase : MonoBehaviour
    {
        ...
        protected virtual void Awake()
        {
            ...
            GameSettingModelBase.current.Initialize();
            GameSettingModelBase.current.OnPreferenceChange += OnPreferenceChange;
        ...
        {
            var s = new GameSettingModelBase.Preference();
            ...
            GameSettingModelBase.current.Save(s);
        }
    }
}